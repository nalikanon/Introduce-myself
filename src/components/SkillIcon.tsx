...
export function SkillIcon({ name }: SkillIconProps): ReactNode {
  const iconMap: Record<string, ReactNode> = {
    ...
    "Docker": <Database className="h-6 w-6 mb-2 mx-auto text-purple-400" />,
    "FastAPI": <Database className="h-6 w-6 mb-2 mx-auto text-purple-400" />,
    "React": <Code className="h-6 w-6 mb-2 mx-auto text-purple-400" />,
    "Vue": <Code className="h-6 w-6 mb-2 mx-auto text-purple-400" />,
